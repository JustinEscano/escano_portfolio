        ...
        <ProjectContent className="text-project-body">
          ...
          <section id="team-members" className="scroll-mt-32 bg-white/5 border border-white/10 rounded-3xl p-6 lg:p-10 mb-12 shadow-2xl backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Justin Paul Louise C. Escano', role: 'Leader / Project Manager', link: 'https://github.com/JustinEscano' },
                { name: 'Ace Philip S. Denulan', role: 'Lead Developer', link: 'https://github.com/naxareth' },
                { name: 'Matthew Cymon S. Estrada', role: 'LLM Engineer & Backend Developer', link: '#' },
                { name: 'Gemerald De Guzman', role: 'UI/UX Designer', link: '#' },
                { name: 'Peter R. Pagasartonga', role: 'Web & Mobile Frontend Developer', link: '#' },
                { name: 'Shierwin Carl Sandino', role: 'Web Frontend Developer', link: '#' },
                { name: 'David Paul Manaloto', role: 'LLM Engineer', link: '#' },
                { name: 'Brian Villegas', role: 'Backend Developer', link: '#' },
                { name: 'Xander Posadas', role: 'Web & Mobile Frontend', link: '#' },
              ].map((member, i) => (
