    ...
    <div className="min-h-screen theme-watchout">
      ...
      <div className="bg-project-main" style={{ minHeight: '100vh', marginTop: '-1px', paddingTop: '2rem' }}>
        <ProjectContent className="text-project-body">
          ...
          <section id="key-features" className="scroll-mt-32 bg-project-card border border-white/10 rounded-3xl p-6 lg:p-10 mb-12 shadow-xl backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                 <h3 className="text-xl font-bold text-project-heading mb-4 border-b pb-2">How to Play</h3>
                 <ul className="space-y-3 font-medium text-project-body">
              ...
              <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4 p-4 rounded-xl border border-slate-200 bg-white hover:border-yellow-400 transition-colors group shadow-sm">
                      ...
                      <div>
                        <h4 className="text-project-heading font-bold text-base mb-1">{feature.title}</h4>
          ...
          {/* Team Members */}
          <section id="team-members" className="scroll-mt-32 bg-project-card border border-white/10 rounded-3xl p-6 lg:p-10 mb-12 shadow-xl backdrop-blur-sm">
            <h2 className="text-3xl font-bold mb-6 pb-4 border-b border-slate-300 text-project-heading flex items-center gap-3">
              <span className="w-2 h-8 bg-[var(--project-accent)] rounded-full inline-block"></span>
              Development Team
            </h2>

            <div className="mb-8 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-project-body text-base sm:text-lg bg-slate-200/50 p-4 rounded-xl shadow-inner border border-slate-200">
              <p><strong className="text-project-heading">Group Name:</strong> <span className="font-bold text-yellow-600">IT-terns</span></p>
              <div className="hidden sm:block w-px h-5 bg-slate-300"></div>
              <p><strong className="text-project-heading">Section:</strong> <span className="font-bold text-slate-700">UP-FA1-BSIT1-01</span></p>
              <div className="hidden sm:block w-px h-5 bg-slate-300"></div>
              <p><strong className="text-project-heading">Date:</strong> <span className="font-bold text-slate-700">October 2023</span></p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white border border-slate-200 hover:border-yellow-400 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg group flex flex-col justify-between">
                  <div className="mb-5">
                    <h3 className="text-project-heading font-bold text-lg leading-tight group-hover:text-yellow-600 transition-colors duration-300">{member.name}</h3>
                  ...
                  <a href={`https://github.com/`} target="_blank" rel="noopener noreferrer" className="mt-auto block w-full">
                    <button className="w-full flex justify-center items-center gap-2 px-3 py-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg text-sm font-bold text-project-body transition-all shadow-sm">
          ...
          {/* Technical Details */}
          <section id="technical-details" className="scroll-mt-32 bg-project-card border border-white/10 rounded-3xl p-6 lg:p-10 mb-12 shadow-xl backdrop-blur-sm">
            <h2 className="text-3xl font-bold mb-8 pb-4 border-b border-slate-300 text-project-heading flex items-center gap-3">
              <span className="w-2 h-8 bg-[var(--project-accent)] rounded-full inline-block"></span>
            ...
            <div className="space-y-12 pb-6">
              ...
              {/* System Architecture */}
              <div>
                <h3 className="text-xl font-bold text-project-heading mb-6">Game Assets & File Explorer</h3>
          ...
          {/* My Contributions */}
          <section id="my-contributions" className="scroll-mt-32 bg-project-card border border-white/10 rounded-3xl p-6 lg:p-10 mb-12 shadow-xl backdrop-blur-sm">
            <h2 className="text-3xl font-bold mb-8 pb-4 border-b border-slate-300 text-project-heading flex items-center gap-3">
              <span className="w-2 h-8 bg-[var(--project-accent)] rounded-full inline-block"></span>
              My Contributions
            </h2>
            <div className="mb-6 pb-6 border-b border-slate-200">
              <p className="text-lg text-project-body font-medium leading-relaxed">
                As a key contributor to <strong className="text-project-heading">Watch Out!</strong>, I was responsible for creating the visual identity and core gameplay mechanics of the game. Here's what I brought to the project:
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-yellow-400 transition-colors duration-300 shadow-sm">
                  <h3 className="text-xl font-bold text-project-heading mb-3 flex items-center gap-2"><span className="text-yellow-600">{contrib.title}</span></h3>
                  <p className="text-project-body leading-relaxed text-sm">
                    {contrib.desc}
                  </p>
                </div>
               ))}
